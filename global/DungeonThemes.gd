...
# Dungeon tiles
const WALL_SANDSTONE = [73, 82]
const WALL_BRICK_DARK = [65, 71]
const WALL_STONE_GREY = [87, 90]
const WALL_ASCII = [72, 72]
const WALL_SLIME_STONE = [83, 86]
const WALL_BRICK_BROWN = [57, 64]

const FLOOR_SANDSTONE = [30, 39]
const FLOOR_BRICK_DARK = [15, 21]
const FLOOR_COBBLE_BLOOD = [4, 14]
const FLOOR_GREEN_SLABS = [40, 55]
const FLOOR_ASCII = [56,56]
const FLOOR_BOG_GREEN = [0, 3]
const FLOOR_MARBLE_BROWN = [22, 29]
